...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AccompanistLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'accompanistSystemUi'.
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'coroutines'.
            ...
            public Provider<MinimalExternalModuleDependency> getCoroutines() {
                return create("firebase.coroutines");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: accompanistSystemUi (0.34.0)
            ...
            /**
             * Returns the version associated to this alias: credentialsManager (1.3.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getCredentialsManager() { return getVersion("credentialsManager"); }
