...
public final class OnboardingViewModel extends androidx.lifecycle.ViewModel {
    ...
    public final void updateTransformationMonths(int v) {
    }
    
    public final void updateWorkoutLocation(@org.jetbrains.annotations.NotNull()
    com.fitquest.rpg.core.domain.model.WorkoutLocation v) {
    }
